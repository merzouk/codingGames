...
public class ChuckNorrisEncodageTest
{
   ...
   {
      assertEquals( "0 0 00 0000 0 000 00 00000 0 0 00 0000 0 00", chuckNorrisEncodage.chuckNorrisEncode( "C C" ) );
   }
   ...
   {
      assertEquals( "0 0 00 00 0 00 00 0 0 00 00 0000 0 00 00 00 0 0 00 00 0 0000 00 0 0 0 00 0 0 0 00 00 0 0 00 0 0 000 00 00 0 0 00 0 0 00 00 0 0 0 00 0 0 0 00 0 0 000 00 00 0 0 00 0 0 0 00 0 0 00 00 0 0 0000 00 0 0 0 00 00 0 0 00 0 0 0 00 0 0 000000 00 00 0 00000000000 00 00 0 00 00 0 0 000 00 0 0 000 00 0 0 0 00 0 0 0000 00 0 0 0 00 0 0 00 00 0 0 0 00 00 0 00000 00 0 0 000 00 0 0 00000 00 0 0 0 00 00 0 0000 00 0000", chuckNorrisEncodage.chuckNorrisEncode( "&a$z%e*r-t+y?y.u:i=o)p" ) );
   }
   /**
    * 
    */
   ...
   {
      assertEquals( "0 0 00 00000", chuckNorrisEncodage.chuckNorrisEncode( " " ) );
   }
